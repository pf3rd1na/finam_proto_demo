...
class Answer extends $pb.GeneratedMessage {
  ...
  Answer._() : super();
  factory Answer.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Answer.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.O3)
    ..aOM<Student>(2, _omitFieldNames ? '' : 'student',
        subBuilder: Student.create)
    ..aOM<Question>(3, _omitFieldNames ? '' : 'question',
...
class Evaluation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.O3)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'answerId', $pb.PbFieldType.O3,
        protoName: 'answerId')
...
class AnsweredQuestion extends $pb.GeneratedMessage {
  ...
  factory AnsweredQuestion.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory AnsweredQuestion.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AnsweredQuestion',
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  AnsweredQuestion copyWith(void Function(AnsweredQuestion) updates) =>
      super.copyWith((message) => updates(message as AnsweredQuestion))
          as AnsweredQuestion;
  ...
  static $pb.PbList<AnsweredQuestion> createRepeated() =>
      $pb.PbList<AnsweredQuestion>();
  @$core.pragma('dart2js:noInline')
  static AnsweredQuestion getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AnsweredQuestion>(create);
...
class Exam extends $pb.GeneratedMessage {
  ...
  Exam._() : super();
  factory Exam.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Exam.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'Exam',
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'id', $pb.PbFieldType.O3)
    ..pc<Question>(2, _omitFieldNames ? '' : 'questions', $pb.PbFieldType.PM,
        subBuilder: Question.create)
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  Exam copyWith(void Function(Exam) updates) =>
      super.copyWith((message) => updates(message as Exam)) as Exam;
  ...
  @$core.pragma('dart2js:noInline')
  static Exam getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Exam>(create);
...
class InterviewMessage extends $pb.GeneratedMessage {
  ...
  factory InterviewMessage.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InterviewMessage.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'InterviewMessage',
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  InterviewMessage copyWith(void Function(InterviewMessage) updates) =>
      super.copyWith((message) => updates(message as InterviewMessage))
          as InterviewMessage;
  ...
  static $pb.PbList<InterviewMessage> createRepeated() =>
      $pb.PbList<InterviewMessage>();
  @$core.pragma('dart2js:noInline')
  static InterviewMessage getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InterviewMessage>(create);
